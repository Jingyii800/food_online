...
MIDDLEWARE = [
    ...
    'orders.request_object.request_object_middleware' #custom middleware to access the request object in models.py
]
...
EMAIL_USE_TLS = True
DEFAULT_FROM_EMAIL = 'foodOnline Marketplace <foodonlinemarket123@gmail.com>'
